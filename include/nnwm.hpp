...
struct nnwm_popup
{
    ...
    struct wlr_scene_tree *parent_tree;  /* immediate parent surface scene tree (for scene parenting) */
    struct wlr_scene_tree *root_tree;    /* root surface scene tree (for constraint coords) */
