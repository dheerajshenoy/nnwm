...
1. Iteration + window handles (biggest missing piece). Right now every action targets the focused window. Real config power needs "for every window matching X, do Y".
